...
if (!supabaseUrl || supabaseUrl === 'YOUR_SUPABASE_URL') {
  console.error("Error: La URL de Supabase no está configurada. Revisa el archivo 'src/lib/supabaseClient.ts'");
}

if (!supabaseAnonKey || supabaseAnonKey === 'YOUR_SUPABASE_ANON_KEY') {
  console.error("Error: La clave anónima (anon key) de Supabase no está configurada. Revisa el archivo 'src/lib/supabaseClient.ts'");
}
